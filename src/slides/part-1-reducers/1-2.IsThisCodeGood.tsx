    ...
    <>
      ...
      {answerVisible && (
        <>
          ...
          <ul>
            <li>
              State updates' "business logic" is scattered throughout the
              component; hard to quickly understand what each handler does
            </li>
            ...
            <li>
              ...
              states (e.g. trying to use <Mono>editorValue</Mono> in readonly
              mode)
            </li>
          </ul>
          <VerticalSpacer />
          <p>
            <strong>Rule of thumb:</strong> If multiple pieces of state depend
            on each other, or if multiple values get updated at the same time,

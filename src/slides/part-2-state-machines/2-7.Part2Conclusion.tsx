...
export function Slide_Part2Conclusion() {
  return (
    <>
      ...
      <ul>
        <li>are simple but powerful tools to describe stateful logic</li>
        <li>can be implemented without any special libraries</li>
        <li>
          can be used in local UI components; no need for external or global
          stores (e.g. Redux)
        </li>
        <li>
          keep state logic organized and fully decoupled from display logic
        </li>
        <li>improve understandability with named states and actions</li>
      ...
      <ul>
        ...
        <li>
          <a href="https://kyleshevlin.com/how-to-use-usereducer-as-a-finite-state-machine">
            How to Use <Mono>useReducer</Mono> as a Finite State Machine
          </a>{' '}
